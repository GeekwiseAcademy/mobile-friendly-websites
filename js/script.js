var sticky = {
  ...
  if (bodyTag.className == 'welcome-msg') {
    setTimeout(function(){ alert("Welcome to Geekwise Academy's Mobile Friendly Websites course. Here are some things you should know: Door code: 25829# WiFi: 'Bitwise' password: BUTTONBOX (all caps) Slack Channel: #mobile-friendly"); }, 2000);
  }
